...
(function (globalfactory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exportsrequire('rrule')require('@fullcalendar/core')) :
    typeof define === 'function' && define.amd ? define(['exports''rrule''@fullcalendar/core']factory) :
    (global = global || selffactory(global.FullCalendarRrule = {}global.rruleglobal.FullCalendar));
}(thisfunction (exportsrrulecore) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var recurring = {
        parse: function (rawEventleftoverPropsdateEnv) {
            if (rawEvent.rrule != null) {
                var props = core.refineProps(rawEventEVENT_DEF_PROPS{}leftoverProps);
    ...
    function parseRRule(inputdateEnv) {
        ...
        if (rrule$1) {
            return { rrule: rrule$1allDayGuess: allDayGuess };
        }
        return null;
    }
