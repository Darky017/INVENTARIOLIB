...
(function (globalfactory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exportsrequire('moment')require('@fullcalendar/core')) :
    typeof define === 'function' && define.amd ? define(['exports''moment''@fullcalendar/core']factory) :
    (global = global || selffactory(global.FullCalendarMoment = {}global.momentglobal.FullCalendar));
}(thisfunction (exportsmomentNscore) { 'use strict';
