...
(function (globalfactory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exportsrequire('luxon')require('@fullcalendar/core')) :
    typeof define === 'function' && define.amd ? define(['exports''luxon''@fullcalendar/core']factory) :
    (global = global || selffactory(global.FullCalendarLuxon = {}global.luxonglobal.FullCalendar));
}(thisfunction (exportsluxoncore) { 'use strict';
