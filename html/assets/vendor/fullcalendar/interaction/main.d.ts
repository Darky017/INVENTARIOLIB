...
declare module '@fullcalendar/interaction/dnd/FeaturefulElementDragging' {
    import { PointerDragEventElementDragging } from '@fullcalendar/core';
    ...
    export { FeaturefulElementDragging as defaultFeaturefulElementDragging };
...
declare module '@fullcalendar/interaction/dnd/PointerDragging' {
    import { EmitterMixinPointerDragEvent } from '@fullcalendar/core';
    export { PointerDragging as defaultPointerDragging };
    class PointerDragging {
        ...
        createEventFromMouse(ev: MouseEventisFirst?: boolean): PointerDragEvent;
        createEventFromTouch(ev: TouchEventisFirst?: boolean): PointerDragEvent;
    }
}
...
declare module '@fullcalendar/interaction/interactions-external/ExternalDraggable' {
    ...
    export { ExternalDraggable as defaultExternalDraggable };
    class ExternalDraggable {
        dragging: FeaturefulElementDragging;
        settings: ExternalDraggableSettings;
        constructor(el: HTMLElementsettings?: ExternalDraggableSettings);
...
declare module '@fullcalendar/interaction/interactions-external/ThirdPartyDraggable' {
    ...
    export { ThirdPartyDraggable as defaultThirdPartyDraggable };
    class ThirdPartyDraggable {
        dragging: InferredElementDragging;
        constructor(containerOrSettings?: EventTarget | ThirdPartyDraggableSettingssettings?: ThirdPartyDraggableSettings);
        destroy(): void;
    }
}
...
declare module '@fullcalendar/interaction/dnd/ElementMirror' {
    ...
    export { ElementMirror as defaultElementMirror };
    class ElementMirror {
        isVisible: boolean;
        origScreenX?: number;
        origScreenY?: number;
        ...
        start(sourceEl: HTMLElementpageX: numberpageY: number): void;
        handleMove(pageX: numberpageY: number): void;
        setIsVisible(bool: boolean): void;
        stop(needsRevertAnimation: booleancallback: () => void): void;
        doRevertAnimation(callback: () => voidrevertDuration: number): void;
        cleanup(): void;
...
declare module '@fullcalendar/interaction/dnd/AutoScroller' {
    ...
    export { AutoScroller as defaultAutoScroller };
    class AutoScroller {
        isEnabled: boolean;
        ...
        start(pageX: numberpageY: number): void;
        handleMove(pageX: numberpageY: number): void;
        stop(): void;
...
declare module '@fullcalendar/interaction/interactions-external/ExternalElementDragging' {
    import { HitPointerDragEventEventTupleDatePointApiCalendarEventInteractionStateDragMetaInputDragMetaViewElementDragging } from '@fullcalendar/core';
    ...
    export { ExternalElementDragging as defaultExternalElementDragging };
    class ExternalElementDragging {
        ...
        constructor(dragging: ElementDraggingsuppliedDragMeta?: DragMetaGenerator);
        handleDragStart: (ev: PointerDragEvent) => void;
        buildDragMeta(subjectEl: HTMLElement): DragMeta;
        handleHitUpdate: (hit: HitisFinal: booleanev: PointerDragEvent) => void;
        handleDragEnd: (pev: PointerDragEvent) => void;
        displayDrag(nextCalendar: Calendar | nullstate: EventInteractionState): void;
        clearDrag(): void;
        canDropElOnCalendar(el: HTMLElementreceivingCalendar: Calendar): boolean;
    }
}
...
declare module '@fullcalendar/interaction/interactions-external/InferredElementDragging' {
    import { PointerDragEventElementDragging } from '@fullcalendar/core';
    import PointerDragging from '@fullcalendar/interaction/dnd/PointerDragging';
    export { InferredElementDragging as defaultInferredElementDragging };
...
declare module '@fullcalendar/interaction/scroll-geom-cache' {
    import { RectScrollController } from '@fullcalendar/core';
    export abstract class ScrollGeomCache extends ScrollController {
        ...
        constructor(scrollController: ScrollControllerdoesListening: boolean);
    ...
    export class ElementScrollGeomCache extends ScrollGeomCache {
        constructor(el: HTMLElementdoesListening: boolean);
...
declare module '@fullcalendar/interaction/interactions/HitDragging' {
    import { EmitterMixinPointerDragEventPointHitInteractionSettingsStoreElementDragging } from '@fullcalendar/core';
    import OffsetTracker from '@fullcalendar/interaction/OffsetTracker';
    export { HitDragging as defaultHitDragging };
    class HitDragging {
        ...
        finalHit: Hit | null;
        coordAdjust?: Point;
        constructor(dragging: ElementDraggingdroppableStore: InteractionSettingsStore);
        handlePointerDown: (ev: PointerDragEvent) => void;
        ...
        handleMove(ev: PointerDragEventforceHandle?: boolean): void;
        prepareHits(): void;
        releaseHits(): void;
        queryHitForOffset(offsetLeft: numberoffsetTop: number): Hit | null;
    }
    export function isHitsEqual(hit0: Hit | nullhit1: Hit | null): boolean;
}
...
declare module '@fullcalendar/interaction/OffsetTracker' {
    ...
    export { OffsetTracker as defaultOffsetTracker };
    class OffsetTracker {
        ...
        computeLeft(): number;
        computeTop(): number;
        isWithinClipping(pageX: numberpageY: number): boolean;
    }
}
