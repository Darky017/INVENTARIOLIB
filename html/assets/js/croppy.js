window.onload = function () {
  ...
  let options = {
    ...
    cropstart: function (e) {
      console.log(e.typee.detail.action);
    },
    cropmove: function (e) {
      console.log(e.typee.detail.action);
    },
    ...
    zoom: function (e) {
      console.log(e.typee.detail.ratio);
    }
  };
  let cropper = new Cropper(imageoptions);
  ...
  actions.querySelector('.docs-toggles').onchange = function (event) {
    ...
    if (isCheckbox || isRadio) {
      ...
      // Restart
      cropper.destroy();
      cropper = new Cropper(imageoptions);
    }
  };
  ...
  actions.querySelector('.docs-buttons').onclick = function (event) {
    ...
    if (data.method) {
      ...
      result = cropper[data.method](data.optiondata.secondOption);
  ...
  function getRoundedCanvas(sourceCanvas) {
    ...
    context.drawImage(sourceCanvas00widthheight);
    context.globalCompositeOperation = 'destination-in';
    context.beginPath();
    context.arc(width / 2height / 2Math.min(widthheight) / 202 * Math.PItrue);
    context.fill();
    return roundcanvas;
  }
