...
; (function ($windowdocumentundefined) {
     ...
     * @param {*} options 
     */
    function bstreeView(elementoptions) {
    ...
    $.extend(bstreeView.prototype{
        ...
        init: function () {
            ...
            var _this = this;
            this.build($(this.element)this.tree0);
        ...
        initData: function (node) {
            ...
            var parent = node;
            var _this = this;
            $.each(node.nodesfunction checkStates(indexnode) {
         ...
         * @param {*} depth 
         */
        build: function (parentElementnodesdepth) {
            var _this = this;
            ...
            $.each(nodesfunction addNodes(idnode) {
                // Main node element.
                ...
                if (node.nodes) {
                    ...
                    _this.build(treeGroupnode.nodesdepth);
                }
            });
        }
    });
    ...
    $.fn[pluginName] = function (options) {
        return this.each(function () {
            if (!$.data(this"plugin_" + pluginName)) {
                $.data(this"plugin_" +
                    pluginNamenew bstreeView(thisoptions));
            }
        });
    };
